...
extern unsigned int texture[11];
...
void make_Player::Draw(glm::vec3 pos,glm::vec3 cameraAt, vector<vec3>& D_vertex, vector<vec3>& D_normal, vector<vec2>& D_vt, GLuint& shaderProgramID)
{
